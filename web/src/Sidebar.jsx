import { Compass, Trophy, User, Zap, Settings2 } from 'lucide-react'
...
export default function Sidebar({ secao, onChange, xp = 1240, onAbrirPreferencias }) {
  return (
    <aside className="w-60 h-full shrink-0 flex flex-col bg-surface-raised border-r border-border">
      ...
      <nav className="flex-1 px-3 py-3 overflow-y-auto" aria-label="Navegação principal">
